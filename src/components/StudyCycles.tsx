                ...
                {editingCycleId === ciclo.id ? (
                  ...
                  <div className="flex justify-between items-start w-full">
                    ...
                    <div className="flex items-center ml-2">
                      <button 
                        onClick={() => { setEditingCycleId(ciclo.id); setEditValue(ciclo.nome); setEditCycleTarget(ciclo.targetMinutes || 0); }}
            ...
            <div className="flex-1 p-4 space-y-2 overflow-y-auto max-h-[350px] scrollbar-thin">
              {ciclo.items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    {editingItemId === item.id ? (
                      <div className="flex flex-col gap-2">
                        ...
                        />
                        <div className="flex items-center gap-2">
                          <Clock className="w-3 h-3 text-slate-400" title="Tempo/Peso" />
                  ...
                  {!editingItemId && (
                    <div className="flex flex-col gap-1 opacity-50 group-hover/item:opacity-100 transition-opacity">
                      <button 
                        onClick={() => {
                          setEditingItemId(item.id);
                          setEditValue(item.materiaNome);
                        ...
                        className="p-1 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded transition-all" title="Editar matéria/peso"
                      >
